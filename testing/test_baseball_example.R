...
#' Real-Data Example: Baseball Data - MMLN Model
#'
#' This function produces an example similar to Gerber & Craig (2021), fitting a mixed
#' effects MLN model to baseball outcome data to predict performance for players switching leagues
#' while accounting for individual player effects
#'
